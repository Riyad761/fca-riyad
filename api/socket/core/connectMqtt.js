...
module.exports = function createListenMqtt(deps) {
  ...
  return function listenMqtt(defaultFuncs, api, ctx, globalCallback) {
    ...
    const username = {
      ...
      ct: "websocket", aid: 2937454996279417, aids: null, mqtt_sid: "",
    ...
    const options = {
      ...
      wsOptions: {
        headers: {
          ...
          "User-Agent": ctx.globalOptions.userAgent || "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36",
